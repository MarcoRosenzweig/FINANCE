...
def actual_prices(date_of_interest, days_to_go_back, Company_Names, OUTPUT_FOLDER,\
    ...
    dates = pd.date_range(end=datetime.date.today(), periods=days_to_go_back, freq='d').strftime('%Y_%m_%d').tolist()
    ...
    Option_Analysis_CPSP = Option_Analysis_Final[["Tickers","Days_to_Exp","Price @ DtE","CPSP",\
                                                 ...
                                                 "MarketCap","Beta","1W %Change","50 Day MA","MA to TP %","Sharpe Ratio",\
                                                 "30day Vol", "95% VaR"]]
